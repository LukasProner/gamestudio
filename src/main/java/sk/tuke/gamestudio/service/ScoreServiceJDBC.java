...
public class ScoreServiceJDBC implements ScoreService {
    ...
    public static final String SELECT_STATEMENT = "SELECT game, player, points, playedOn FROM score WHERE game = ? ORDER BY points ASC LIMIT 10";
    ...
    public List<Score> getTopScores(String game) {
        try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            System.out.println("dostal si pripojenie");
